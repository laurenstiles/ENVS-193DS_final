...
seedcount <-read_csv(here("data/knb-lter-nwt.297.1/seedcount.csv")) |> #reading in data 
            ...
            select("nr_seeds", "total_nr_infl", "plant_nr", 
                   "tag_num") #selecting specific needed columns
...
seedcount3.a <- glmmTB(nr_seeds ~ total_nr_infl + plant_nr + tag_num, data = seedcount, family = "nbinom2")

```
Look at residuals
```{r}
plot(simulateResiduals(seedcount1))
```
